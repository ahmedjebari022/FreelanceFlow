          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full md:w-auto">
              {!subscribed ? (
                ...
                <div className="alert alert-success max-w-md shadow-lg">
                  <svg
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold">FreelanceFlow</h2>
            </div>
            <p className="mb-4 text-base-content/70">
              The premier platform connecting skilled freelancers with clients
              looking for quality services across diverse categories.
            </p>
          ...
          <div>
            <h3 className="footer-title text-lg font-bold mb-4">For Clients</h3>
          ...
          <div>
            <h3 className="footer-title text-lg font-bold mb-4">Company</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/about"
